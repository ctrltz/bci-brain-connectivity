...
\newcommand{\formulaSNRProcessing}{SNR $\sim$ Inv. + ROI + Mask + (1 $|$ Subject) + (1 $|$ Pipeline)}
\newcommand{\formulaConnectivityProcessing}{PS $\sim$ Inv. + ROI + Band + Mask + (1 $|$ Subject) + (1 $|$ Pipeline)}
\newcommand{\formulaConnectivityProcessingSNR}{PS $\sim$ SNR + Inv. + ROI + Band + Mask + (1 $|$ Subject) + (1 $|$ Pipeline)}
